...
class BaseTester(object):
    ...
    def evaluate(self,
        ...
        for basin in pbar:
            ...
            for freq in ds.frequencies:
                ...
                # print("\n")
                # print("feature_center: {}".format(feature_center))
                # print("feature_scaler: {}".format(feature_scaler))
                # print("\n")

                # print("\n")
                # print("y_hat_freq: {}".format(y_hat[freq]))
                # print("\n")

                # rescale predictions
                if y_hat[freq].ndim == 3 or (len(feature_scaler) == 1):
                    # print("\n")
                    # print(type(y_hat[freq]))
                    # print("\n")
                    # p = 1.2
                    # y_hat_abs = np.abs(y_hat[freq])
                    # y_hat[freq] = np.sign(y_hat[freq]) * (y_hat_abs ** (1 / p))
                    y_hat_freq = y_hat[freq] * feature_scaler + feature_center
                    # y_hat_freq = np.exp(y_hat_freq)
                    # lambda_opt = 0.1701358620622596
                    # y_hat_freq = (y_hat_freq * lambda_opt + 1) ** (1 / lambda_opt)
                ...
                # print("\n")
                # print("y_hat_freq: {}".format(y_hat_freq))
                # print("\n")
    ...
    def _evaluate(self, model: BaseModel, loader: DataLoader, frequencies: List[str], save_all_output: bool = False):
        ...
        # print("\n")
        # print("predict_last_n: {}".format(predict_last_n))
        # print("\n")
