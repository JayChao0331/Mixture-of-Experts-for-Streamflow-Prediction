...
class Config(object):
    ...
    def checkpoint_path(self, path: str):
        self._cfg["checkpoint_path"] = path
    ...
    def distributed_backend(self) -> str:
        return self._cfg.get("distributed_backend", "nccl")

    @property
    def distributed_local_rank(self) -> int:
        return self._cfg.get("distributed_local_rank", 0)

    @property
    def distributed_rank(self) -> int:
        return self._cfg.get("distributed_rank", 0)

    @property
    def distributed_world_size(self) -> int:
        return self._cfg.get("distributed_world_size", 1)
    ...
    @property
    def gamma(self) -> int:
        return self._get_value_verbose("gamma")
    ...
    def num_gpus(self) -> int:
        return self._cfg.get("num_gpus", 1)
    ...
    def run_name(self) -> str:
        return self._cfg.get("run_name", None)
