...
def get_loss_obj(cfg: Config) -> loss.BaseLoss:
    ...
    elif cfg.loss.lower() == "mse_regularized":
        loss_obj = loss.MaskedMSELoss_Regularized(cfg)
    elif cfg.loss.lower() == "peak_mse":
        loss_obj = loss.PeakMSELoss(cfg)
    elif cfg.loss.lower() == "low_mse":
        loss_obj = loss.LowMSELoss(cfg)
    elif cfg.loss.lower() == "wmse":
        loss_obj = loss.MaskedWeightedMSELoss(cfg)
